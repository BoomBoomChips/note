...
### **5.2.1** v-model读取json数据

最开始

![image-20200313235026860](assets\image-20200313235026860.png)

会失败

![image-20200313235243018](assets\image-20200313235243018.png)

然后改v-model就可以了

![image-20200313235347326](C:\Users\87676\AppData\Roaming\Typora\typora-user-images\image-20200313235347326.png)

结果

![image-20200313235425644](D:\note\Vue\assets\image-20200313235425644.png)
...
注意：这个event事件，method哪里，形参注意看，相当于将$event对象传入了decrement(ev)，ev是形参
...
**index不是我们数据data里面的东西，要遍历的话，所以在外面另外加Index**
